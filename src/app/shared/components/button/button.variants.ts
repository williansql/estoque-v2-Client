...
export const buttonVariants = cva(
  ...
  ),
  {
    variants: {
      zType: {
        default: 'bg-[#13325b] text-primary-foreground hover:bg-[#13325b]/80',
        destructive:
          'bg-destructive/10 hover:bg-destructive/20 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/20 text-destructive focus-visible:border-destructive/40 dark:hover:bg-destructive/30',
        outline:
          'border-border bg-background hover:bg-muted hover:text-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:text-foreground',
        secondary:
          'bg-[#13325b]/20 text-[#13325b] hover:bg-[#13325b]/80 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground',
        warning:
          'bg-amber-400/20 border border-amber-400/50 text-amber-900 hover:bg-amber-600 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground',
        ghost:
